...
public class PageFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
        ...
        if(mPage==1)
        {
                ...
                public void onClick(View v) {
                    switch(state1)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(1,nameofproject1,description1);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state2)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(2,nameofproject2,description2);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                }
                ...
                public void onClick(View v) {
                    switch(state3)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(3,nameofproject3,description3);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state4)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(4,nameofproject4,description4);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state5)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(5,nameofproject5,description5);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state6)//获取Button状态
                    {
                        ...
                        case DYING:
                            ...
                            break;
                        case INUSE:
                            dialogInuse(6,newdate6,state6,nameofproject6,description6, needdays6,nowdays6);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                        case DONE:
                            dialogDone(6,nameofproject6,description6);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state7)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(7,nameofproject7,description7);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state8)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(8,nameofproject8,description8);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
                ...
                public void onClick(View v) {
                    switch(state9)//获取Button状态
                    {
                        ...
                        case INUSE:
                            ...
                            break;
                        case DONE:
                            dialogDone(9,nameofproject9,description9);
                            //这些参数是前面声明的 用于测试 实质为从数据库获取的该项目的各个信息
                            break;
                    }
            ...
            ImageButton bt2=(ImageButton)view.findViewById(R.id.outside2);
            ...
            ImageButton bt3=(ImageButton)view.findViewById(R.id.outside3);
            ...
            ImageButton bt4=(ImageButton)view.findViewById(R.id.outside4);
            ...
            ImageButton bt5=(ImageButton)view.findViewById(R.id.outside5);
            ...
            ImageButton bt6=(ImageButton)view.findViewById(R.id.outside6);
            ...
            ImageButton bt7=(ImageButton)view.findViewById(R.id.outside7);
            bt2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    dialogDone(3,"好好学习","我今天好好学习了");
            ...
            ImageButton bt8=(ImageButton)view.findViewById(R.id.outside8);
            ...
            ImageButton bt10=(ImageButton)view.findViewById(R.id.outside10);
...
//        打卡
    ...
    public void dialogDone( int id, String nameofproject,
                            String description) {
        //需要舒畅在这个界面加时间轴
